                                ...
                                <div class="item mt-5">
                                    ...
                                    <div class="item-details">
                                        ...
                                        <div class="item-title">
                                            <a style="display: inline-block;display: block;padding: 0;color: #fff;font-weight: 600;font-size: 20px;text-transform: uppercase;-webkit-transition: all .35s;transition: all .35s;margin-top: 15px;margin-bottom: 0px;border-radius: 0;background: #131313;text-transform: capitalize;border: 1px solid transparent;-webkit-transition: all .3s;transition: all .3s;width: auto;padding: 3px 30px;border-radius: 5px;height: 45px;/* align-items: center; */"
