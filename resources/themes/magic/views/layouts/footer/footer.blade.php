                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="ps-footer--address">
                            <div class="ps-logo"><a href="/"> <img src="{{ asset('magic/assets/img/habib/logo.png') }}" alt=""><img
                                        class="logo-white" src="{{ asset('magic/assets/img/logo-white.png') }}" alt=""><img
                                        class="logo-black" src="{{ asset('magic/assets/img/Logo-black.png') }}" alt=""><img
                                        class="logo-white-all" src="{{ asset('magic/assets/img/logo-white1.png') }}" alt=""><img
                                        class="logo-green" src="{{ asset('magic/assets/img/logo-green.png') }}" alt=""></a></div>
                ...
                <div class="row">
					...
					@endphp
							...
							<div class="ps-footer--block">
								...
								<ul class="ps-block__list">
									@foreach($pagess as $p)
									<li><a href="/page/{{ $p->url_key}}">{{$p->page_title}}</a></li>
									@endforeach
                    ...
                    <div class="col-12 col-md-4">
                        <div class="footer-link-widget widget-install-app col  wow animate__ animate__fadeInUp animated"
                            ...
                            <img src="{{ asset('magic/assets/img/habib/paymob.png') }}" alt="Payment gateways">
                            <img src="{{ asset('magic/assets/img/habib/Picture2.png') }}" alt="Payment gateways">
                            <img src="{{ asset('magic/assets/img/habib/Picture3.png') }}" alt="Payment gateways">
                            <img src="{{ asset('magic/assets/img/habib/Picture4.png') }}" alt="Payment gateways">
                            <img src="{{ asset('magic/assets/img/habib/Picture5.png') }}" alt="Payment gateways">
                        </div>
                    </div>
                </div>
            </div>
