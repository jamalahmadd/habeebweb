...
@section('content-wrapper')
    ...
    <div class="content full-page">
        ...
        <div class="page-header">
            ...
            @if ($order->status_mobile != "Canceled")
                <div class="page-action">
                    ...
                    @if ($order->canRefund() &&  $order->status_mobile == "ORDER_DELIVERED")
                    ...
                    @endif
					 <a href="{{ route('admin.sales.orders.change.process', $order->id) }}" class="btn btn-lg btn-primary">
                            Change Status
                        </a>
            ...
            <tabs>
                ...
                <tab name="{{ __('admin::app.sales.orders.info') }}" :selected="true">
                    <div class="sale-container">
                                ...
                                <div class="sale-section">
                                    ...
                                    <div class="section-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <span class="value">
												@if ($order->status_mobile == 'PROCESSED') 
                										ORDER PROCESSED
												@elseif ($order->status_mobile == 'DELIVERING')
														OUT FOR DELIVERY
												@elseif( $order->status_mobile == 'ORDER_DELIVERED')
													ORDER DELIVERED
												@elseif( $order->status_mobile == 'ORDER_DELIVERED_WITH_ITEM_RETURNED') 																		ORDER DELIVERED [with Item returned]
												@elseif ($order->status_mobile == 'COLLECTING')
													UNDER COLLECTION
												@elseif ($order->status_mobile == 'CANCELED')
													{{'ORDER '.str_replace('_',' ',$order->status_mobile)}}
												
												@else
													{{str_replace('_',' ',$order->status_mobile)}}
												@endif
                                            </span>
                                        </div>
                        ...
                        @if (($order->billing_address || $order->shipping_address) && $order->location)
                            <accordian :title="'{{ __('admin::app.sales.orders.address') }}'" :active="true">
                                <div slot="body">

                                    Location area: {{ $order->location->area }}
									<br>
                                    Street name: {{ $order->location->street_name }}
									<br>
									Building type: {{ $order->location->building_type }}
									<br>
									Building name: {{ $order->location->street_name }}
									<br>
									Floor number: {{ $order->location->floor_number }}
									<br>
									Apartment number: {{ $order->location->apartment_number }}
									<br>
									Address number: {{ $order->location->address_name }}
									<br>
                                ...
                                @if ($order->shipping_address)
                                    <div class="sale-section">
                                        ...
                                        <div class="section-content">
                                            ...
                                            <div class="row">
                                                <span class="title">
                                                    {{ __('admin::app.sales.orders.shipping-price') }} hh
                                                </span>
                            ...
                            <div slot="body">
                                ...
                                <div class="table">
                                    <table>
									 ...
									 <td>
									<div class="action"><a href="{{ Route('edititem',$item->id) }}" data-method="GET" ><span class="icon pencil-lg-icon"></span></a></div>
									</td>
                                                </tr>
                                            @endforeach
                                    </table>
