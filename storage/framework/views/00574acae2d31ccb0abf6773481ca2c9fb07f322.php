    ...
    <div class="navbar-top-left">
        ...
        <div class="brand-logo">
            <a href="<?php echo e(route('admin.dashboard.index')); ?>">
                ...
                <?php else: ?>
                    <default-image style="width:100% !important;height:50px !important;"
            ...
            <div class="store">
                <div>
                    <a  href="<?php echo e(route('shop.home.index')); ?>" target="_blank" style="display: inline-block; vertical-align: middle;">
                        <span class="icon store-icon "  data-toggle="tooltip" text="<?php echo e(__('admin::app.layouts.visit-shop')); ?>" data-placement="bottom"></span>
                    </a>
                </div>
            </div>
...
</div><?php /**PATH /var/www/vhosts/hab.mobi/httpdocs/packages/Webkul/Admin/src/Providers/../Resources/views/layouts/nav-top.blade.php ENDPATH**/ ?>