    ...
    <script type="text/x-template" id="group-list-template">
        <div style="margin-top: 20px">
                        ...
                        <div class="page-content">
                            <div class="form-container">
                                <div class="control-group" :class="[errors.has('add-group-form.name') ? 'has-error' : '']">
                                    <label for="name" class="required"><?php echo e(__('admin::app.catalog.families.name')); ?></label>
                                    <input type="text" v-validate="'required'" v-model="group.name" class="control" id="name" name="name" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.families.name')); ?>&quot;"/>
            ...
            <modal id="editGroupForm" :is-open="$root.modalIds.editGroupForm">
                <h3 slot="header"><?php echo e(__('admin::app.catalog.families.edit-group-title')); ?></h3>
                        ...
                        <div class="page-content">
                            <div class="form-container">
                                <div class="control-group" :class="[errors.has('edit-group-form.name') ? 'has-error' : '']">
                                    <label for="name" class="required"><?php echo e(__('admin::app.catalog.families.name')); ?></label>
                                    <input type="text" v-validate="'required'" v-model="editGroup.name" class="control" id="name" name="name" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.families.name')); ?>&quot;"/>
                                ...
                                <div class="control-group" :class="[errors.has('edit-group-form.position') ? 'has-error' : '']">
                                    <label for="position" class="required"><?php echo e(__('admin::app.catalog.families.position')); ?></label>
                                    <input type="text" v-validate="'required|numeric'" v-model="editGroup.position" class="control" id="position" name="position" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.families.position')); ?>&quot;"/>
                                    <span class="control-error" v-if="errors.has('edit-group-form.position')">{{ errors.first('edit-group-form.position') }}</span>
                                </div>
            
                                <button type="submit" class="btn btn-lg btn-primary">
                                    <?php echo e(__('admin::app.catalog.families.update-group-title')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/hab.mobi/httpdocs/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/families/edit.blade.php ENDPATH**/ ?>