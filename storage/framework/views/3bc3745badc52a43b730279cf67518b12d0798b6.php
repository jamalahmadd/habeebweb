...
<accordian title="<?php echo e(__('admin::app.catalog.products.videos')); ?>" :active="false">
    <div slot="body">
        ...
        <div class="control-group <?php echo e($errors->has('videos.files.*') ? 'has-error' : ''); ?>">
            ...
            <span
                class="control-error"
                v-text="'<?php echo e($errors->first('videos.files.*')); ?>'">
            </span>
            
            <span class="control-info mt-10"><?php echo e(__('admin::app.catalog.products.video-size', ['size' => core()->getMaxUploadSize()])); ?></span>
        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/vhosts/hab.mobi/httpdocs/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/products/accordians/videos.blade.php ENDPATH**/ ?>