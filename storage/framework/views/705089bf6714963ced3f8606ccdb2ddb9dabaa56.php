...
<?php $__env->startSection('content-wrapper'); ?>
    ...
    <modal id="duplicateInvoiceFormModal" :is-open="modalIds.duplicateInvoiceFormModal">
        ...
        <div slot="body">
            <form
                method="POST"
                action="<?php echo e(route('admin.sales.invoices.send-duplicate-invoice', $invoice->id)); ?>"
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/hab.mobi/httpdocs/packages/Webkul/Admin/src/Providers/../Resources/views/sales/invoices/view.blade.php ENDPATH**/ ?>