...
<?php $wishlist = app('Webkul\Customer\Models\Wishlist'); ?>
...
<?php $__env->startSection('seo'); ?>
    <meta name="description"
        content="<?php echo e(trim($product->meta_description) != '' ? $product->meta_description : \Illuminate\Support\Str::limit(strip_tags($product->description), 120, '')); ?>" />
                                ...
                                <div class="row">
                                        ...
                                        <div class="product-gallery product-gallery-vertical ">
                                            <div class="row">
                                                <figure class="product-main-image">
                                                    ...
                                                    <div class='zoom'>
                                                        <img src="<?php echo e($productBaseImage['original_image_url']); ?>" id="Mainimg1"
                                                            data-zoom-image="<?php echo e($productBaseImage['original_image_url']); ?>"
                                                            data-toggle="lightbox" alt="product image"/>

                                                    </div>

                                                    <a href="<?php echo e($productBaseImage['original_image_url']); ?>" class="btn-product-gallery">
                                                ...
                                                <div id="zoomGallery" class="product-image-gallery filter  hdpe">
                                                    ...
                                                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <a class="product-gallery-item   <?php if($loop->first): ?> active <?php endif; ?>" href="#"
                                                            data-zoom-image="<?php echo e($image['original_image_url']); ?>">
                                                            <img   src="<?php echo e($image['original_image_url']); ?>" id="Mainimg"
                                    ...
                                    <div class="col-12 col-md-6 ">
                                        <div class="ps-product__info">
                                            ...
                                            <div class="ps-product__title"><a href="#"><?php echo e($product->name); ?></a></div>
                                            ...
                                            <div class="ps-product__type">
                                                <ul class="ps-product__list">
                                                    <li> <span class="ps-list__title">Brand: </span><a
                                                            class="ps-list__text" href="#"><?php echo e($product->brand_label); ?></a>
                                                    </li>
													<li> <span class="ps-list__title">Tags: </span><a
                                                            class="ps-list__text" href="#"><?php echo e($product->meta_keywords); ?></a>
                                                    </li>
											  ...
											  <!-- 	<div class="fb-share-button" 
												...
												<li><div class="fb-share-button" 
													...
													data-layout="button">
																							 ...
																							 <li style="height:20px; border-radius:3px; width:66px;"><a class="ps-social__link twitter"  href="https://twitter.com/intent/tweet?text=https://habeeb.verozone.cloud/<?php echo e($product->product->url_key); ?>" style=" height:100%; width:100%; line-height:20px; font-size:11px; color:#ffffff;   padding:0 6px;font-family: Helvetica, Arial, sans-serif;"><i
												...
												"whatsapp://send?text=https://habeeb.verozone.cloud/<?php echo e($product->product->url_key); ?>"
                                                  ...
                                                  <!--  <li><div class="fb-share-button" 
                                                   ...
                                                   <!--Commented <li><a class="ps-social__link twitter"  href="https://twitter.com/intent/tweet?text=https://habeeb.verozone.cloud/<?php echo e($product->name); ?>"><i
                                                                class="fa fa-twitter"></i><span
                                                                class="ps-tooltip">Twitter</span></a></li>
													 <li><a class="ps-social__link whatsapp"  href=
												"whatsapp://send?text=https://habeeb.verozone.cloud/<?php echo e($product->name); ?>"
   											     data-action="share/whatsapp/share"
...
Tweet</a>-->
                            ...
                            <div class="col-12 col-md-3">
                                <form method="POST" id="product-form" action="<?php echo e(route('cart.add', $product->product_id)); ?>"
                                    ...
                                    <div class="ps-product__feature">
                                        ...
                                        <div class="ps-product__meta"><span class="ps-product__price"style="color: black;"><?php echo $product->getTypeInstance()->getPriceHtml(); ?></span>
                                        </div>
...
<form method="POST" action="<?php echo e(route('customer.review.add')); ?>">	
	<?php echo csrf_field(); ?>
<div class="rating">
...
fjs.parentNode.insertBefore(js, fjs);
    ...
    <script>
        var config = <?php echo json_encode(isset($config) ? $config : null, 15, 512) ?>;
...
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/hab.mobi/httpdocs/resources/themes/magic/views/products/view.blade.php ENDPATH**/ ?>