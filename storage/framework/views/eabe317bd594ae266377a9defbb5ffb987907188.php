<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.index')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Run Profile -->
    <accordian :title="'<?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.index')); ?>'" :active="true">
        <div slot="body">
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/x-template" id="profiler-template">
        <div class="run-profile">
            <form action="<?php echo e(route('bulk-upload-admin.run-profile')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="control-group">
                        <label for="export-product-type"><?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.select-file')); ?></label>

                        <select class="control" id="data-flow-profile"  v-model="data_flow_profile" name="data_flow_profile">
                            <option><?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.please-select')); ?></option>

                                <?php if(isset($profiles)): ?>
                                    <?php $__currentLoopData = $profiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $__currentLoopData = $profile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getProfileToExecute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($getProfileToExecute->id); ?>">
                                                <?php echo e($getProfileToExecute->name); ?>
                        ...
                        <div class="page-action">
                            ...
                            <?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.run')); ?>
    ...
    <script type="text/x-template" id="uploadingRecords-template">
        <ul>
            <li>
                ...
                <span><?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.profile-execution')); ?></span>
            </li>

            <li v-if="this.countOfError > '0'">
                <i class="icon cross-accent"></i>
                <span><?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.error-count')); ?>:  {{this.countOfError}}</span>
            </li>

            <li v-if="this.countOfError > '0'">
                <i class="icon cross-accent"></i>
                <span >
                <?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.error-in-product')); ?> :
            ...
            <li>
                <i class="icon check-accent"></i>
                <span><?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.warning')); ?></span>
            </li>
            ...
            <li>
                <i class="icon check-accent"></i>
                <span> {{this.uploadedProducts}}/{{this.totalRecords}} <?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.products-uploaded')); ?></span>
            </li>

            <li v-if="this.remainData == '0'">
                <i class="icon finish-icon"></i>
                <span><?php echo e(__('bulkupload::app.admin.bulk-upload.run-profile.finish')); ?> </span>
            </li>
        </ul>
    </script>
        ...
        Vue.component('profiler', {
            ...
            methods:{
                ...
                runProfiler: function(e) {
                    ...
                    const uri = "<?php echo e(route('bulk-upload-admin.read-csv')); ?>"
                    this.$http.post(uri, {
                ...
                initiateProfiler: function(totalRecords) {
                    ...
                    const url = "<?php echo e(route('bulk-upload-admin.run-profile')); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/hab.mobi/httpdocs/packages/Webkul/Bulkupload/src/Providers/../Resources/views/admin/bulk-upload/run-profile/index.blade.php ENDPATH**/ ?>