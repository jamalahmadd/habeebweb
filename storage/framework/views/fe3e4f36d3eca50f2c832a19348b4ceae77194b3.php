...
<accordian title="<?php echo e(__('admin::app.catalog.products.images')); ?>" :active="false">
    <div slot="body">
        ...
        <div class="control-group <?php echo e($errors->has('images.files.*') ? 'has-error' : ''); ?>">
            ...
            <span
                class="control-error"
                v-text="'<?php echo e($errors->first('images.files.*')); ?>'">
            </span>

            <span class="control-info mt-10"><?php echo e(__('admin::app.catalog.products.image-size')); ?></span>
        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/vhosts/hab.mobi/httpdocs/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/products/accordians/images.blade.php ENDPATH**/ ?>